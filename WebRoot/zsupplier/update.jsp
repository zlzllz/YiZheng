...
<html>
  ...
  <body>
	<form action="${pageContext.request.contextPath}/SupplierServlet?tag=update" method="post">
	<input type="hidden" name="id" value="<%=request.getParameter("id") %>" />
	<table>
	<tr><td colspan="2">修改供货商信息</td></tr>
	<tr><td>供货商名称:</td><td><input type="text" name="sname"/></td></tr>
	<tr><td>供货商电话:</td><td><input type="text" name="tel"/></td></tr>
